...
const approvedLogoBase64 = (await readFile('scripts/assets/sila-approved-v4-512.jpg.b64', 'utf8')).trim()
...
console.log('Prepared index.html with embedded approved Family logo.')
