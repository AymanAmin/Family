const CACHE_VERSION = 'sila-v26-install-v14'
...
const PRECACHE_PATHS = [
  ...
  'icons/icon-approved-v4-192.jpg?v=14',
  'icons/icon-approved-v4-512.jpg?v=14',
  'icons/maskable-approved-v4-512.jpg?v=14',
  'icons/apple-touch-icon-approved-v4.jpg?v=14',
  'brand/sila-approved-v4.jpg?v=14',
  'brand/sila-mark.svg?v=14',
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    icon: appUrl('icons/icon-approved-v4-192.jpg?v=14'),
